...
其實「職業定位」這件事情，放諸任何職業都一樣，沒有一個準則

不過因為資料科學界不比其他領域成熟，並且開始應用在不同產業，每個產業的切入角度又完全不同，分歧聲音就更多了



到底為什麼資料科學家/工程師的定義如此分歧？

即使只看 Google 與 Facebook 兩間公司，他們內部對於相關職缺的定位跟分工可能就有差異了

因此要明確定義「什麼職缺一定做什麼、一定不做什麼」是不可能的事情

不過可以試著從幾個方向來探討「為什麼這麼難劃分」。
...
這中間的任何步驟都是牽一髮而動全身，些微的需求更改，都可能會造成整條資料流必須砍掉重練，甚至重新設計不同架構；但在看到實驗結果之前，很難知道結果是否就是我們要的，所以大規模改動就無法避免，因此 data consumer 與 data provider 的關係就會非常緊密，絕對不是工作分下去、各部門按照規格做事即可。
...
拿資料工程師來說好了，即使硬要歸類，他也能算是軟體工程師的一種類別，但訓練與轉行並非簡單之事，原本在職的資深工程師未必全部都有興趣轉行作資料工程師
...
一線大公司尚且如此，而新創通常不容易有充足的人力，就更不用說了，有的公司較少科學家，那工程師就要實作一部分的理論模型，或是提供簡單可用的演算法（有時候這樣也就足夠了）
...
有些新創非常重視研究，科學家占了不少比例；但我也同時看到一些新創公司的產品有 AI 或機器學習的功能，但他們並不大量徵求機器學習工程師或科學家，而是著重在前端應用體驗，或後端工程。

這中間沒有對與錯，每間公司需要的人才比例不會一樣，通常也會隨著時間變動

但如果需要的比例與公司內比例相差太多，就會發生科學家兼職工程師、或是工程師兼職科學家的情形。

### 外部的好奇與不夠全面的猜測加深了神祕色彩

資料科學與機器學習雖然在近年成為顯學，多數人仍然缺乏實務經驗但卻充滿著好奇，也促使一些外部的觀察與推測不停發生，很多斷然下的結論不能算錯，頂多只能說是「比較單一面向」

這情形也不只存在機器學習或 AI 領域，光是軟體工程師就有千百種，每間公司做的都不一樣，不是嗎？那資料科學家與工程師沒有明確且單一的定義，也就是合情合理的事情了

只是去談論、去好奇一般工程師的人少，在資料科學卻多了起來，並不是好現象

猜的人多、講的人也多，做的人卻少，從所謂「大數據」時代就一直是這樣了，但台灣真正有動手做大數據的恐怕還是少數
...
有人提出他在國外千人公司，也是全包；另一位鄉民表示他在傳統零售業，即使員工總數超過二十萬人，科學家也是要自己清資料；甚至也有網路上的人說出「科學家的工作就是要清資料」這種看似極度不合理（但搞不好才是真實？）的論調

### 所以，雖然那張金字塔的圖上面有兩條「界線」，但對每間公司、每個組織來說，不可能永遠都是同樣的標準

## 到底這些工作是怎麼被分工的？有沒有大致的輪廓？

參考金字塔圖，依序從頂端、底部、中間來講

注意，這裡講的是「分成哪些工作」而非「什麼職稱做什麼工作」

有可能你掛資料工程師但做很多資料科學家的事情，或是反過來。

### 資料科學家 \(Data Scientist\) 或 ML Researcher

> 資料科學家當然是做演算法跟實驗啊，不然要幹嘛？

對頂尖 CS 背景出身的科學家來說，或許 feature engineering 或寫程式產生 ETL 都不會是問題，但人的時間有限，所以理想上希望科學家專心在 ML 演算法的實驗與設計上

你可能要根據產品需求設計很多實驗流程，找出最有可能改善模型的方法

你可能要研讀論文、推導邏輯與式子並證明自己的解法可行（或別人的論文不可行？）

你可能要實作現有的 ML solution 到既有產品上

你可能要在一堆看似雜亂無章的資料中挖掘他們的價值，做出對公司有利的提案

你也有可能做一堆 excel 報表、整天對著 database 下 SQL

你也可能為了要把實驗放到產品上，自己寫了很多程式，同時是後端伺服器工程師也是資料工程師

你當然也有可能為了說服大家採用你的提案，把預測結果做出漂亮的視覺化，因此你碰了很多前端視覺工具
...
資料太多了，以致於多數時候沒有辦法在單機做完 ETL，所以分散式運算的經驗就變得非常重要，像是 partition 要怎麼切？一個 job 要使用多少資源才合適？指桑罵槐的錯誤訊息該怎麼解讀？有一個節點掛了你能分辨是硬體還是網路的問題嗎？

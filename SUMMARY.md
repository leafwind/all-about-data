...
* [（尚未發佈）維護你的「軟體食譜」](software-engineering/maintain-your-software-cookbook.md)
...
* [真實世界的資料](data-engineering/real-world-data.md)
  ...
  * [（尚未發佈）無法重現、難以追本溯源、幾乎不可能避免](data-engineering/wu-fa-zhong-xian-3001-nan-yi-zhui-ben-su-yuan-3001-ji-hu-bu-ke-neng-bi-mian.md)
* [資料的複雜度](data-engineering/complexity-of-data.md)
  * [（尚未發佈）Data 可以比 code 還難懂](data-engineering/data-can-be-harder-understand-than-code.md)
  * [（尚未發佈）積非成是的資料，與其相對應的龐大代價](data-engineering/the-cost-of-two-wrongs-make-a-right.md)
* [（尚未發佈）Data Schema 設計原則](data-engineering/things-about-ETL.md)
